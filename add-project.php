...
if (isset($_POST["uploadfilesub"])) {
    ...
    // Inserting todo
    $sql = "INSERT INTO `project` (uuid,type,project_title,`project_desc`,project_url,image)  VALUES ('$uuid','$type','$project_title','$project_desc','$project_url','$filename')";
                ...
                <div class="card bg-white rounded border shadow">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                <button type="submit" name="uploadfilesub" class="btn btn-primary me-2">Submit</button>
